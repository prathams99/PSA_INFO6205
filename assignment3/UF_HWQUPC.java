...
//        }
    ...
    private static void count(int n) {
        ...
        System.out.println("Connections existing: " + connections);
        System.out.println("Pairs generated: " + pairs + "\n");
    }

    // If you prefer, you can create a main program that doesn't require any input and runs the experiment for a fixed set of n values. Show evidence of your run(s).
    public static void main(String[] args) {
        int[] numbers = {100, 150, 200, 250, 300, 250, 400, 450};
        for (int number : numbers) {
            System.out.println("Number of sites are: " + number);
            int n = number;
